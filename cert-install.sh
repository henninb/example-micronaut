...
cp -vi "${server_name}.p12" "src/main/resources/${server_name}-example-keystore.p12"
cp -vi "${server_name}.crt" "ssl/hornsup-example-cert.pem"
cp -vi "${server_name}.key" "ssl/hornsup-example-key.pem"
